...
<div class="container">
  ...
  <div class="ibasPanelSize text-center">
    <div class="panel panel-default">
      <div class="panel-heading text-left"><span>输入注册信息</span></div>
      <div class="panel-body">
        <form class="text-center" action="admin_register" method="post">
          ...
          <input type="submit" style = "width: 98%;" class="btn btn-primary btn-group-lg" value="注册"/>
        </form>
      </div>
